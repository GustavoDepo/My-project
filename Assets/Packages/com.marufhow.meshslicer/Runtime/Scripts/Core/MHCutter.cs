...
namespace com.marufhow.meshslicer.core
{
    public class MHCutter : MonoBehaviour
    {
        ...
        public void Cut(GameObject cutObject, int step)
        {
            ...
            Vector3 lowestPoint = new Vector3(bounds.center.x, bounds.min.y + step, bounds.center.z);
            Plane plane = new Plane(Vector3.up, lowestPoint);
